        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainWalletId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Wallets_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Wallets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_Wallets_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Wallets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("97b94d94-3dde-4e4b-82ea-017fe0a9552f"), null, "User", "User" },
                    { new Guid("cdb5f2c1-08f4-4957-9b15-22d047af9b8b"), null, "Admin", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MainWalletId",
                table: "AspNetUsers",
                column: "MainWalletId",
                unique: true,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Wallets_MainWalletId",
                table: "AspNetUsers",
                column: "MainWalletId",
                principalTable: "Wallets",
                principalColumn: "Id",
